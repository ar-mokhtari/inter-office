inherited serialBankF: TserialBankF
  Left = 124
  Caption = #1576#1575#1606#1705' '#1587#1585#1610#1575#1604' '#1607#1575
  ClientWidth = 646
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object qryserials: TADOQuery
    Connection = DmF.adoMain
    CursorType = ctStatic
    AfterInsert = qryserialsAfterInsert
    BeforeEdit = qryserialsBeforeEdit
    AfterEdit = qryserialsAfterEdit
    AfterPost = qryserialsAfterPost
    AfterCancel = qryserialsAfterCancel
    BeforeDelete = qryserialsBeforeDelete
    AfterDelete = qryserialsAfterDelete
    Parameters = <>
    SQL.Strings = (
      'Select *'
      'From SerialNoBank')
    Left = 72
    Top = 72
    object qryserialsSerialID: TWideStringField
      DisplayLabel = #1588#1605#1575#1585#1607' '#1587#1585#1610#1575#1604' '#1705#1575#1604#1575
      FieldName = 'SerialID'
      Size = 14
    end
    object qryserialsModelNo: TWideStringField
      DisplayLabel = #1605#1583#1604' '#1705#1575#1604#1575
      FieldName = 'ModelNo'
      Size = 11
    end
    object qryserialsContainerNo: TWideStringField
      DisplayLabel = #1588#1605#1575#1585#1607' '#1705#1575#1606#1578#1610#1606#1585
      FieldName = 'ContainerNo'
      Size = 11
    end
  end
  object dssrcserials: TDataSource
    DataSet = qryserials
    Left = 88
    Top = 120
  end
  object actlstBs: TActionList
    Left = 40
    Top = 16
