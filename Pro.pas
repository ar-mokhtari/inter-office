...
begin
  ...
  s:=searchCode_ADOF.SearchCode2(DmF.adoMain,'',txt,['ﬂœ „‘ —Ì','‰«„ „‘ —Ì'],result,[50,150],alLeft);
  if s then
  begin
...
begin
  ...
  s:=searchCode_ADOF.SearchCode2(DmF.adoMain,'Ã” ÃÊÌ „Ê«—œ',txt,
       ['ﬂœ »«“«—Ì«»Ì','ﬂœ ‘—ﬂ ','‰«„ ‘—ﬂ ','‰«„ „Œ«ÿ»',' «—ÌŒ',' Ê÷ÌÕ« '],result,
