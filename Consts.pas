...
{My Farsi Version of Consts.Pas to localize dialog messages}
{*******************************************************}
...
resourcestring
  ...
  SMsgDlgCancel = '«‰’—«›';
  SMsgDlgHelp = '&—«Â‰„«';
  SMsgDlgHelpNone = 'ÂÌç —«Â‰„«ÌÌ œ— œ” —” ‰Ì” ';
  SMsgDlgHelpHelp = '—«Â‰„«';
  SMsgDlgAbort = '&·€Ê';
  SMsgDlgRetry = '&”⁄Ì „Ãœœ';
  SMsgDlgIgnore = '&—œ ò—œ‰';
  SMsgDlgAll = '&Â„Â';
  SMsgDlgNoToAll = 'ŒÌ— »—«Ì Â„Â';
  SMsgDlgYesToAll = '»·Â »—«Ì Â„Â';
  ...
  SConfirmCreateDir = '„”Ì— „‘Œ’ ‘œÂ ÊÃÊœ ‰œ«—œ°¬Ì« «ÌÃ«œ ‘Êœø';
  SSelectDirCap = '«‰ Œ«» „”Ì—';
  SDirNameCap = '‰«„ ÅÊ‘Â&';
  SDrivesCap = 'œ—«ÌÊÂ«';
  SDirsCap = 'ÅÊ‘Â Â«';
